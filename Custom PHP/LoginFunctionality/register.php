...
$username_err = $email_err = $password_err = $confirm_password_err = '';
    ...
    if(empty($email)){
        ...
        if($stmt->execute()){
            ...
            if($stmt->rowCount() === 1){
            $email_err = 'Email is already being used, try using another one or, <a href="login.php">Login Here</a>.';
            }
        } else {
        ...
        <div class="card card-body bg-light mt-5">
          ...
          <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
            <div class="form-group">
              ...
              <input type="text" name="name" class="form-control form-control-lg <?php echo (!empty($username_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $username; ?>">
